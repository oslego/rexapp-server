...
Crawler.prototype.crawl = function(config){
    var self = this,
        options = {
            ...
            timeout: 10000,
            headers: {
                // Fake an User-Agent. Pesky server-side developers forbidding curl. No more of this!
                "User-Agent": "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_2) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1312.36 Safari/537.17",
            }
        }
    ...
    request(options, function(error, response, body){
        ...
        if (!error && response.statusCode == 200){
            ...
            if (!body){
                ...
                console.error("No body for ", config.id)
                return
            }
